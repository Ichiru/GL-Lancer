...
{
    public abstract class NamedObject : DataIniFile
    {
        ...
        protected NamedObject(Section section, FreelancerIni data)
            : base(data)
        {
        ...
        protected NamedObject(Vector3 pos, FreelancerIni data)
            : base(data)
        {
            Pos = pos;
        }
