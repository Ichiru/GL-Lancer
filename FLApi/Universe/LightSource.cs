...
namespace FLApi.Universe
{
    ...
    {
        public Color? Color { get; private set; } // = 255, 255, 255
        ...
        public LightSource(Vector3 pos, Color color, int range, FreelancerIni data)
            : base(pos, data)
        {
            Color = color;
            Range = range;
        ...
        public LightSource(Section section, FreelancerIni data)
            : base(section, data)
        {
