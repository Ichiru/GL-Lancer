...
{
    public sealed class Nebula : Material
    {
        /// <summary>
        /// Emissive Color
        /// </summary>
        public Color Ec { get; private set; }

        public Nebula(IntermediateNode node, ILibFile textureLibrary, string type)
        ...
        {
            //if (effect != null) effect.Parameters["Ec"].SetValue(Ec.ToVector4());
			if (effect != null)
				effect.SetParameter ("Ec", Ec.ToVector4 ());
