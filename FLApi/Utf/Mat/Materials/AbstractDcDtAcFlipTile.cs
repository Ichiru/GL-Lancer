...
{
    public abstract class AbstractDcDtAcFlipTile : AbstractDcDtAcFlip
    {
        ...
        public AbstractDcDtAcFlipTile(IntermediateNode node, ILibFile textureLibrary, string type)
        ...
        {
            if (effect != null) effect.Parameters["TileRate"].SetValue(TileRate);
