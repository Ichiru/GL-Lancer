...
namespace FLApi.Utf.Vms.Vertices
{
    public struct VertexPositionNormalTextureTwo : IVertexType
    {
            ...
            : this()
        {
            ...
            this.TextureCoordinateTwo = new Vector2(reader.ReadSingle(), reader.ReadSingle());
        }
        ...
        public VertexDeclaration VertexDeclaration
        {
            get
            {
                return new VertexDeclaration(
                    ...
                    new VertexElement(sizeof(float) * (3 + 3 + 2), VertexElementFormat.Vector2, VertexElementUsage.TextureCoordinate, 1));
            }
        }
    }
}