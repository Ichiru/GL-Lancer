...
{
    public class Bodypart : DataIniFile
    {
        ...
        public DfmFile Mesh
        {
            get
            {
                if (mesh == null) mesh = new DfmFile(FreelancerIni.DataPath + meshPath, null);
                return mesh;
            }
        }

        public Bodypart(Section s, FreelancerIni freelancerIni)
            : base(freelancerIni)
        {
