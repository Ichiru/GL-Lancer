...
{
    public class Costume : DataIniFile
    {
        ...
        public Bodypart Head
        {
            get
            {
                if (head == null && headName != null) head = FreelancerIni.Bodyparts.FindBodypart(headName);
                return head;
            }
        }
        ...
        public Bodypart Body
        {
            get
            {
                if (body == null && bodyName != null) body = FreelancerIni.Bodyparts.FindBodypart(bodyName);
                return body;
            }
        }
        ...
        public Bodypart RightHand
        {
            get
            {
                if (rightHand == null && rightHandName != null) rightHand = FreelancerIni.Bodyparts.FindBodypart(rightHandName);
                return rightHand;
            }
        }
        ...
        public Bodypart LeftHand
        {
            get
            {
                if (leftHand == null && leftHandName != null) leftHand = FreelancerIni.Bodyparts.FindBodypart(leftHandName);
                return leftHand;
            }
        }
        ...
        public Accessory Accessory
        {
            get
            {
                if (accessory == null && accessoryName != null) accessory = FreelancerIni.Bodyparts.FindAccessory(accessoryName);
                return accessory;
            }
        }

        public Costume(Section s, FreelancerIni freelancerIni)
            : base(freelancerIni)
        {
        ...
        public Costume(string headName, string bodyName, string accessoryName, FreelancerIni freelancerIni)
            : base(freelancerIni)
        {
